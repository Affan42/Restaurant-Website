...
function startAnim() {
  ...
  const animations = [
    ...
    {
      minVal: window.matchMedia("(max-width: 420px)").matches ? 200 : 0,
      navItem: document.querySelectorAll(".nav-item")[0],
      elems: [
    ...
    {
      minVal: window.matchMedia("(max-width: 420px)").matches ? 1000 : 400,
    ...
    {
      minVal: window.matchMedia("(max-width: 420px)").matches ? 800 : 400,
      navItem: document.querySelectorAll(".nav-item")[1],
      elems: [
        {
    ...
    {
      minVal: window.matchMedia("(max-width: 420px)").matches ? 1600 : 1200,
    ...
    {
      minVal: window.matchMedia("(max-width: 420px)").matches ? 2500 : 2400,
    ...
    {
      minVal: window.matchMedia("(max-width: 420px)").matches ? 3000 : 2400,
      navItem: document.querySelectorAll(".nav-item")[3], // No specific nav item provided for Ingredients
      elems: [
        {
    ...
    {
      minVal: window.matchMedia("(max-width: 420px)").matches ? 3700 : 3400,
    ...
    {
      minVal: window.matchMedia("(max-width: 420px)").matches ? 4100 : 3400,
      navItem: document.querySelectorAll(".nav-item")[3],
      elems: [
        {
    ...
    {
      minVal: window.matchMedia("(max-width: 420px)").matches ? 4500 : 3400,
      navItem: document.querySelectorAll(".nav-item")[3],
      elems: [
        {
    ...
    {
      minVal: window.matchMedia("(max-width: 420px)").matches ? 4900 : 3400,
      navItem: document.querySelectorAll(".nav-item")[3],
      elems: [
        {
    ...
    {
      minVal: window.matchMedia("(max-width: 420px)").matches ? 5100 : 3400,
      navItem: document.querySelectorAll(".nav-item")[3],
      elems: [
        {
    ...
    {
      minVal: window.matchMedia("(max-width: 420px)").matches ? 6200 : 4200,
